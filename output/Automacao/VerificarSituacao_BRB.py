        ...
        for index, linha in faturas_df.iterrows():
            ...
            for index, linha2 in guia_df.iterrows():
                ...
                try:
                    ...
                    try:
                        todos = webdriver.find_element(By.XPATH, '//*[@id="localizarprocedimentos"]/div[2]/div/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/div/div[5]/a')
                        hover = ActionChains(self.webdriver).move_to_element(todos)
                        hover.perform()
                        procedimentos = webdriver.find_element(By.XPATH, '//*[@id="tooltip535066"]').text.replace('-', '').replace('.', '')
